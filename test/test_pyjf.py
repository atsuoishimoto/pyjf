...
class TestGuess(unittest.TestCase):
    ...
    def testUTF8(self):
        s = open("utf8.txt").read()
        self.failUnlessEqual(guess(s), UTF8)

    def testSingleKana(self):
        sjis = '\xb1\xb2\xb3\xb4\xb5'
        euc = '\x8e\xb1\x8e\xb2\x8e\xb3\x8e\xb4\x8e\xb5'
        jis = '\x1b(I12345\x1b(B'
        utf8 = '\xef\xbd\xb1\xef\xbd\xb2\xef\xbd\xb3\xef\xbd\xb4\xef\xbd\xb5'
        ...
        sjis = '\xb1\xb2\xb3\xb4\xb5\x83A\x83C\x83E\x83G\x83I'
        euc = '\x8e\xb1\x8e\xb2\x8e\xb3\x8e\xb4\x8e\xb5\xa5\xa2\xa5\xa4\xa5\xa6\xa5\xa8\xa5\xaa'
        jis = '\x1b(I12345\x1b(B\x1b$B%"%$%&%(%*\x1b(B'
        utf8 = '\xef\xbd\xb1\xef\xbd\xb2\xef\xbd\xb3\xef\xbd\xb4\xef\xbd\xb5\xe3\x82\xa2\xe3\x82\xa4\xe3\x82\xa6\xe3\x82\xa8\xe3\x82\xaa'
...
class TestEncodigs(unittest.TestCase):
    ...
    def testNECKanji(self):
        sjis = open("nec.txt").read()
        self._conv(sjis)
        
        sjis = open("necibm.txt").read()
        self._conv(sjis)
        
    def testIBMKanji(self):
        sjis = open("ibm.txt").read()
    ...
    def testRandom(self):
        s = "".join([
            open("sjis.txt").read(),
            open("hankana.txt").read(),
            open("nec.txt").read(),
            open("necibm.txt").read(),
            open("ibm.txt").read(),
        ])
...
class TestConv(unittest.TestCase):
    def testKana(self):
        s = unicode(open("hankana.txt").read(), "cp932")
        full = kanatofull(s)
